...
import {
  ...
  useSetCurrentOrganizationIndex,
...
export default function ProfilePanel({ close }: { close: PanelCloseType }) {
  ...
  const { data: organizations, isLoading: OrganizationLoading } =
    useOrganizationsByUserQuery(id ?? null);
  ...
  if (ProfileLoading || OrganizationLoading) return <></>;
  return (
    <div className="h-[714px] w-[400px] py-4 rounded-md  bg-white shadow-md overflow-y-auto ">
      <div className="flex flex-col h-full px-8 py-10">
        <div className="flex gap-6 self-baseline">
          ...
          <div className="flex flex-col gap-y-1">
            ...
            <div>
              <button
                className="flex text-xl text-blue-primary font-bold"
                onClick={() => {
                  close();
                  router.push("/profile"), close();
                }}
              >
            ...
            <div className="mt-1">
              <button
                className="flex text-xl text-red  font-bold"
                onClick={() => {
                  close();
        ...
        <div className="mt-7">
          <button
            ...
            onClick={() => {
              close();
              router.push("/organizations"), close();
            }}
          >
            <LuEdit className="mr-1" />
        ...
        <OrganizationSelect
          close={close}
          value={currentOrganizationIndex}
