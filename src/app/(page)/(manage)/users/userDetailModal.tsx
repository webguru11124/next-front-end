...
import useOrganizationUserRemove from "@/api/organization_access/useOrganizationUserRemove";
              ...
              <div className="flex  mt-8 justify-between">
                <button
                  ...
                  onClick={() => {
                    close();
                    openModal({
                      modalType: ModalType.InviteUser,
                      id: user?.id,
                    });
                  }}
                >
        ...
        <div className="mt-16  flex justify-center">
          <div className="flex-col ">
            ...
            <div className="flex gap-x-5">
              <div className="text-gray-lighter text-xl">Role:</div>
