...
export default function DropdownEditModal() {
  ...
  return (
    modal === ModalType.DropdownEditModal && (
      <Modal width="xl" className="h-[604px] py-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-2 gap-x-14  gap-y-6 px-6  ">
              ...
              {fields.length > 0 ? (
                ...
                <div className="col-start-1">{addButton}</div>
              )}
            </div>
            <div className="mt-5 py-10 flex justify-center">
              {mutateLoading ? (
                ...
                <button
                  type="submit"
                  className="rounded-md text-[18px] bg-blue-primary py-2.5 px-7 text-white mr-12 font-bold"
                >
                  Save
                </button>
              )}
