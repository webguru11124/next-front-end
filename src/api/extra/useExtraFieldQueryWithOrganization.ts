...
export default function useExtraFieldQueryWithOrganization() {
    ...
    const { data, isLoading, error, isError, isFetching, isPreviousData, refetch } = useExtraFieldsQuery(id);
    return {
        data, isLoading: isOrgLoading || isLoading, error, isError, isFetching, isPreviousData, refetch
    };
}
